# Istruzioni per la Gestione dei Requisiti e User Stories

Questa cartella contiene i template e le linee guida per definire la seconda fase della documentazione di progetto: i requisiti e le user stories.

## Scopo della Cartella

La cartella `02-requirements` rappresenta la seconda fase di documentazione del progetto e fornisce una struttura gerarchica per organizzare i requisiti di vari tipi. Qui si definiscono:

- User stories e epic per catturare le esigenze degli utenti
- Requisiti funzionali categorizzati per tipo
- Requisiti non funzionali per qualità e performance
...
- **01-project-definition/**: I requisiti devono allinearsi con gli obiettivi definiti e lo scope del progetto
- **03-behavioral-diagrams/**: Le user stories e i requisiti sono la base per i diagrammi comportamentali
- **04-structural-diagrams/**: I requisiti funzionali guidano la progettazione delle classi e componenti
- **05-database-design/**: I requisiti relativi ai dati si riflettono nel modello ER
