# REQ-NF-SEC-XXX: [Titolo Requisito Security]
...
[Spiegazione completa di cosa il sistema deve soddisfare dal punto di vista della sicurezza]

### Motivazione Business

[Perché questo requisito di sicurezza è importante per il business]

### Impatto Utente

[Come questo requisito di sicurezza influenza l'esperienza utente]
...
**Unità di Misura**: [Percentuale/Numero/Tempo/etc.]  
...
**Tipo di Test**: [Penetration/Security/Vulnerability]  
...
| Security Engineer | [Nome] | ______ | ______ |
