# REQ-NF-COMP-XXX: [Titolo Requisito Compatibility]
...
[Spiegazione completa di cosa il sistema deve soddisfare dal punto di vista della compatibilità]

### Motivazione Business

[Perché questo requisito di compatibilità è importante per il business]

### Impatto Utente

[Come questo requisito di compatibilità influenza l'esperienza utente]
...
**Tipo di Test**: [Cross-platform/Cross-browser/Integration]  
