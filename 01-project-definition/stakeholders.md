...
- **Livello 1**: Team Lead / Project Manager
- **Livello 2**: Product Owner / Department Manager
- **Livello 3**: Executive Sponsor / C-Level
...
- **Identificazione**: Stakeholder identifica necessità di cambiamento
- **Documentazione**: Compilazione change request form
- **Valutazione**: Analisi impatto (tempo, costi, risorse)
- **Approvazione**: Decisione da parte del comitato appropriato
- **Implementazione**: Aggiornamento piani e comunicazione
